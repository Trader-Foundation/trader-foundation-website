...
**CLOSED. Ruled by Trader Foundation.** See `rulings/hammer-strength.md`. Not a
...
**Raised 8 September 2026, by a real question during testing.** The bot was
asked whether a 20 SMA target was reasonable on GGLL, a 2x leveraged GOOGL
product, while the chart shown was GOOGL itself.
...
## Outcome language still waiting on a decision

Three passages are flagged `needs_review` in `compliance-log.md` rather than
excluded, because each is arguably teaching rather than a performance claim and
excluding is the reversible direction only until somebody rules.

- Module 16: *"make you very wealthy"* and *"great way to really make some great
  money"*.
- Module 1: *"you will literally have my whole portfolio"*.

Non-negotiable 1 forbids specific financial outcome claims. None of these names
a figure, which is why they were not auto-excluded, and all three promise an
outcome in words. **Question:** do these stay, and if they stay does the bot
quote them or only teach around them?
