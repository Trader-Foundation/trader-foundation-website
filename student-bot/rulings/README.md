...
A ruling is a Trader Foundation decision, not an inference from the transcript and not a fallback to standard convention. If it has not been confirmed by the house, it goes in `open-questions.md`, not here.
