        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-3">
              ...
              <p className="text-[#444] text-base leading-relaxed mb-4">
                That failure became fuel. Vlad tried every method until he found what actually works &mdash; and here's what makes him different from every other trading educator: <strong>two decades teaching Fortune 500 executives</strong>. Great traders don't always make great teachers. Vlad mastered both, and gives away more free education than most programs charge for because he believes everyone deserves access to real financial knowledge.
              </p>
              <p className="text-[#444] text-base leading-relaxed mb-4">
                That mission runs deeper than one person. The coaches on this team aren't people who came here because they had no other options &mdash; they're <strong>smart, successful professionals</strong>. <strong>Elliot</strong> spent a decade in the options markets. <strong>Erin</strong> built her career in corporate finance at GE, reading P&amp;Ls and analyzing risk for a living. <strong>Leo</strong> spent 13 years in the markets developing the Paycheck Collector strategy. And even they needed people. Each of them joined Trader Foundation as a student &mdash; because being smart isn't the same as having a system, and being successful isn't the same as having a team. They mastered the system, then came back to teach it. Every coach on this team is living proof that what we teach works, and that even the sharpest people don't have to do it alone.
              </p>
