  ...
  return (
    <>
      ...
      <ol className="space-y-3 mb-6 text-[1.02rem] leading-[1.8] text-[#444] list-decimal list-inside">
        ...
        <li><strong>Set aside an active trading account:</strong> Separate from your long-term holdings, fund a brokerage account specifically for swing trades. <strong>A minimum of $15,000+ is required to start</strong>, this gives you enough room to apply the Paycheck Collector method properly while keeping your risk controlled.</li>
