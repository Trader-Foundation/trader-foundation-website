  ...
  return (
    <>
      ...
      <ol className="space-y-3 mb-6 text-[1.02rem] leading-[1.8] text-[#444] list-decimal list-inside">
        ...
        <li><strong>Set aside an active trading account:</strong> Separate from your long-term holdings, fund a brokerage account specifically for swing trades. Start with capital you can afford to risk while you are learning. We recommend starting with at least $15,000 in trading capital to apply the strategy properly while keeping your risk controlled.</li>
          ...
          <aside className="hidden lg:block w-[280px] shrink-0">
            <div className="sticky top-[100px]">
              <div className="bg-[#111] rounded-lg overflow-hidden shadow-xl">
                <img
                  src={SIDEBAR_IMG}
                  alt="Vlad Tayman teaching at Trader Foundation Academy"
