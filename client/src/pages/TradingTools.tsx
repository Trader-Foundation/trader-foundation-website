...
import { ArrowRight, ChevronRight, MonitorSmartphone, BarChart3, BookOpen, Wrench, Target, Shield, Clock } from 'lucide-react';
...
const TOC = [
  { id: 'right-platform', label: 'Choosing the Right Brokerage Platform' },
  { id: 'charting-software', label: 'Charting Software That Actually Matters' },
  { id: 'stock-screeners', label: 'Stock Screeners: Finding Setups in Minutes' },
  { id: 'options-chain', label: 'Reading an Options Chain Without the Confusion' },
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <article className="flex-1 min-w-0">
            <div style={{ fontFamily: "'DM Sans', sans-serif" }}>
              ...
              {/* ── Section 1: Choosing the Right Brokerage Platform ── */}
              <section id="right-platform" className="mb-16 scroll-mt-36">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-[#c7ab77]/10 flex items-center justify-center">
                    <MonitorSmartphone size={20} className="text-[#c7ab77]" />
                  </div>
                  <h2
                ...
                <div className="bg-white rounded-lg border border-[#e8e4dc] p-6 md:p-8 my-4 shadow-sm">
                  <div className="space-y-5">
                    {[
                      {
                        title: 'Commission-Free Options Trading',
                        desc: 'Most major brokerages have eliminated stock commissions, but options contracts still carry per-contract fees at some platforms. Look for brokerages that charge $0.65 or less per contract — or nothing at all.',
                      },
                      {
                        title: 'Reliable Order Execution',
                        desc: 'When you place a limit order on an options spread, you need it filled at your price or not at all. Brokerages with poor execution quality will cost you more than any commission savings.',
                      },
                      {
                        title: 'Clean Options Chain Interface',
                        desc: 'You will be reading options chains regularly. The platform should display strike prices, bid/ask spreads, open interest, and implied volatility in a layout that does not require a decoder ring.',
                      },
                      {
                        title: 'Conditional & Bracket Orders',
                        desc: 'Swing trading means you are not glued to a screen. You need the ability to set automatic profit targets and stop losses that execute while you are at work or with your family.',
                      },
                      {
                        title: 'Mobile App Quality',
                        desc: 'Many of our students scan for setups during lunch breaks or after market hours. A mobile app that mirrors the desktop experience — including charting and order entry — is essential.',
                      },
                    ].map((item, i) => (
              ...
              {/* ── Section 2: Charting Software That Actually Matters ── */}
              <section id="charting-software" className="mb-16 scroll-mt-36">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-[#c7ab77]/10 flex items-center justify-center">
                  ...
                  <h2
                    ...
                    style={{ fontFamily: "'Sen', sans-serif" }}
                  >
                    Charting Software That Actually Matters
                  </h2>
                </div>
                ...
                <h3
                  ...
                  style={{ fontFamily: "'Sen', sans-serif" }}
                >
                  The Indicators We Actually Use
                </h3>
                    ...
                    {[
                      {
                        ...
                        use: 'Identify the overall trend direction and dynamic support/resistance levels. We focus on the 20, 50, and 200-day moving averages for swing trade timeframes.',
                      },
                      {
                        name: 'Relative Strength Index (RSI)',
                        use: 'Measure momentum and identify overbought or oversold conditions. Useful for timing entries when a stock has pulled back to a support zone.',
                      },
                      {
                        name: 'Volume Profile',
                        use: 'Confirm the strength of a price move. A breakout on heavy volume carries more conviction than one on thin volume — a principle our students learn to apply on every trade.',
                      },
                      {
                        name: 'MACD (Moving Average Convergence Divergence)',
                        use: 'Spot momentum shifts and potential trend reversals. Particularly useful when combined with support/resistance analysis for swing trade entry timing.',
                      },
                    ].map((ind, i) => (
                      <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-5">
                        <h4 className="text-[#c7ab77] font-bold text-[0.9rem] mb-2" style={{ fontFamily: "'Sen', sans-serif" }}>
                          {ind.name}
                        </h4>
                        <p className="text-white/60 text-[0.85rem] leading-relaxed mb-0">
                          {ind.use}
                        </p>
                      </div>
                    ))}
              ...
              {/* ── Section 3: Stock Screeners ── */}
              <section id="stock-screeners" className="mb-16 scroll-mt-36">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-[#c7ab77]/10 flex items-center justify-center">
                  ...
                  <h2
                    ...
                    style={{ fontFamily: "'Sen', sans-serif" }}
                  >
                    Stock Screeners: Finding Setups in Minutes
                  </h2>
                </div>
                ...
                <h3
                  ...
                  style={{ fontFamily: "'Sen', sans-serif" }}
                >
                  Filters Our Students Typically Apply
                </h3>
              ...
              {/* ── Section 4: Reading an Options Chain ── */}
              <section id="options-chain" className="mb-16 scroll-mt-36">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-[#c7ab77]/10 flex items-center justify-center">
                    <Wrench size={20} className="text-[#c7ab77]" />
                  </div>
                  <h2
                    className="text-2xl md:text-3xl font-bold text-[#111] m-0"
                    style={{ fontFamily: "'Sen', sans-serif" }}
                  >
                    Reading an Options Chain Without the Confusion
                  </h2>
                </div>
                ...
                <div className="bg-white rounded-lg border border-[#e8e4dc] p-6 md:p-8 my-4 shadow-sm">
                  <div className="space-y-5">
                    {[
                      {
                        title: 'Bid & Ask',
                        desc: 'The bid is what buyers are willing to pay; the ask is what sellers want. The difference between them — the spread — tells you how liquid that contract is. Tighter spreads mean better fills.',
                      },
                      {
                        title: 'Open Interest',
                        desc: 'The total number of outstanding contracts at a given strike. Higher open interest means more participants and more liquidity. We generally avoid strikes with open interest below 100.',
                      },
                      {
                        title: 'Implied Volatility (IV)',
                        desc: 'A measure of how much the market expects the stock to move. Higher IV means higher premiums — which can be advantageous when you are selling options, as we often do in our credit spread strategies.',
                      },
                      {
                        title: 'Delta',
                        desc: 'Tells you the probability that the option will expire in the money. A delta of 0.30 means roughly a 30% chance. For our strategies, we typically look for deltas between 0.15 and 0.30 on the short leg — keeping the probability of profit firmly in our favor.',
                      },
                      {
                        title: 'Days to Expiration (DTE)',
                        desc: 'How many days until the contract expires. Swing traders and premium sellers tend to work in the 30 to 45 DTE range, where time decay accelerates and works in your favor.',
                      },
                    ].map((item, i) => (
                      <div key={i} className="flex items-start gap-4">
                        <span className="w-8 h-8 rounded-full bg-[#111] flex items-center justify-center shrink-0 mt-0.5">
                ...
                <p className="text-[1.05rem] leading-relaxed text-[#444]">
                  ...
                  <a href="/options-trading" className="text-[#c7ab77] font-semibold hover:underline">
                    Learn more about our options strategies →
                  </a>
                </p>
              </section>

              {/* ── Section 5: The Time Machine ── */}
              <section id="time-machine" className="mb-16 scroll-mt-36">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-[#c7ab77]/10 flex items-center justify-center">
                    <Clock size={20} className="text-[#c7ab77]" />
                  </div>
                  <h2
                    className="text-2xl md:text-3xl font-bold text-[#111] m-0"
                    style={{ fontFamily: "'Sen', sans-serif" }}
                  >
                    The Time Machine: Practice Before You Risk
                  </h2>
                </div>
                ...
                <div className="bg-[#111] rounded-lg p-8 my-8">
                  <h3
                    ...
                    style={{ fontFamily: "'Sen', sans-serif" }}
                  >
                    How the Time Machine Process Works
                  </h3>
                  <div className="space-y-4">
                    {[
                      {
                        step: 'Step 1',
                        title: 'Historical Setup Review',
                        desc: 'Your coach presents you with a stock chart from a past date — stripped of the outcome. You analyze it using the technical framework you have learned and decide: would you enter this trade?',
                      },
                      {
                        step: 'Step 2',
                        title: 'Trade Plan Submission',
                        desc: 'You document your entry price, stop loss, profit target, position size, and the reasoning behind each decision. This forces you to think through the trade systematically, not emotionally.',
                      },
                      {
                        step: 'Step 3',
                        title: 'Outcome Reveal & Coach Feedback',
                        desc: 'Your coach reveals what actually happened and walks through your analysis. Where was your read accurate? Where did you miss something? What would you adjust next time?',
                      },
                      {
                        step: 'Step 4',
                        title: 'Pattern Library Building',
                        desc: 'Over dozens of Time Machine sessions, you build a mental library of setups you have seen before. When a similar pattern appears in the live market, you recognize it — and you have the confidence to act because you have already practiced the decision.',
                      },
                    ].map((item, i) => (
                      <div key={i} className="flex items-start gap-4">
                        <div className="w-16 shrink-0">
                          <span className="text-[#c7ab77] text-[0.75rem] font-bold uppercase tracking-wider">
                            {item.step}
                          </span>
                        </div>
                        <div>
              ...
              <section id="trading-journal" className="mb-16 scroll-mt-36">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-[#c7ab77]/10 flex items-center justify-center">
              ...
              {/* ── Section 7: Alerts & Automation ── */}
              <section id="alerts-automation" className="mb-16 scroll-mt-36">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-[#c7ab77]/10 flex items-center justify-center">
                  ...
                  <h2
                    ...
                    style={{ fontFamily: "'Sen', sans-serif" }}
                  >
                    Alerts & Automation for Busy Professionals
                  </h2>
                </div>
                ...
                <h3
                  ...
                  style={{ fontFamily: "'Sen', sans-serif" }}
                >
                  Types of Automation Our Students Use
                </h3>
                  ...
                  <div className="space-y-5">
                    {[
                      ...
                      },
                      {
                        ...
                        desc: 'Once you enter a trade, set both your profit target and stop loss as conditional orders. If the stock hits either level, the position closes automatically. You can be in a meeting, at dinner, or asleep — the trade manages itself.',
                      },
                      {
                        title: 'Watchlist Scanning',
                        desc: 'Most charting platforms let you save custom screener filters. Run them once a day — typically after market close or before the open — to refresh your watchlist with new candidates that meet your criteria.',
                      },
                      {
                        title: 'Calendar Reminders',
                        desc: 'Set reminders for earnings dates, FOMC meetings, and expiration Fridays. These events can cause sudden volatility, and knowing they are coming lets you adjust positions or avoid entering new trades during high-risk windows.',
                      },
                    ].map((item, i) => (
                      <div key={i} className="flex items-start gap-4">
                        <span className="w-8 h-8 rounded-full bg-[#111] flex items-center justify-center shrink-0 mt-0.5">
              ...
              <section className="bg-[#111] rounded-lg p-8 md:p-10">
                <h2
                  ...
                  style={{ fontFamily: "'Sen', sans-serif" }}
                >
                  Ready to Build Your Trading Toolkit?
                </h2>
                <p className="text-white/60 text-[1rem] mb-6 leading-relaxed">
                  The right tools are only half the equation — you also need the right guidance. Watch our free masterclass to see how our swing trading system works, and learn how your 1-on-1 coach will help you set up everything from day one.
                </p>
                <a
